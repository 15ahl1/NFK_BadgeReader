...
def deleteUser(userIdentificationNumber):
    ...
    print("Hello again" + str(userIdentificationNumber))
...
def machineStatus(machine, userID):
    with app.app_context():
        cur = mysql.connection.cursor()
